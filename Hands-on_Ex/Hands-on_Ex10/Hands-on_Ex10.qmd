...
determine bandwidth: - use grf.bw(formula, dataset, kernel, coordinates)

results: 1. explanatory variable stats 2. predictive model stats
...
plot ggplot (predicted values versus fitted model) - compare with ols plot
