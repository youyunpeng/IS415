...
# create coords for training for rf
coords_train_rf<-st_coordinates(train_data_rf)
```
...
write_rds(coords_train_rf, "data/model/coords_train_rf.rds")
```
...
coords_train_rf<-read_rds("data/model/coords_train_rf.rds")
```
...
### Converting the predictint output into a dataframe
