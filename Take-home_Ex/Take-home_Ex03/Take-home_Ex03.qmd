...
we were unable to gain the bandwidth result even after extensive waiting. For the assignment requirementes, we will consider the bandwidths generated and choose the one that gives the highest R2 value. The output generated can be seen in the screenshots attached:
